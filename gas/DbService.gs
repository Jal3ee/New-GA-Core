...
function setupAssetsSheets() {
  ...
  if (!unitSheet) {
    ...
    unitSheet.appendRow(['id', 'no_lambung', 'no_polisi', 'unit_asset', 'site', 'dept', 'user_pengguna', 'merk', 'warna', 'type', 'no_rangka', 'no_mesin', 'bahan_bakar', 'stnk_start', 'stnk_end', 'file_url', 'budget_tahunan', 'status_unit', 'created_at', 'updated_at']);
  }
